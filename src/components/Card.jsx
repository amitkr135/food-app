...
function Card({ name, image, id, price, type }) {
    ...
    return (
        <div className="w-[300px] h-[400px] bg-white p-3 rounded-lg flex flex-col gap-3 shadow-lg hover:border-2 border-green-300 ">
            ...
            <button className="w-full p-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-400 transition-all" onClick={()=>dispatch(AddItem({id:id,name:name,image:image,price:price,qty:1}))}>Add to Card</button>
        </div>
    );
}
